 ...
 */
public class WindowListActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.window_detail_container) != null) {
            ...
            ((WindowListFragment) getSupportFragmentManager()
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(WindowDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(WindowDetailFragment.ARG_ITEM_ID, id);
